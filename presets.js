const commonControlConfig = {
  ...
  contactTime: { label: "Contact Time (s)", type: "range", min: 15, max: 1200, step: 5 },
...
export const brewMethodPresets = {
  espresso: {
    ...
    defaults: {
      ...
      contactTime: 28,
      pressure: 9,
      pressureAggressiveness: 46,
      preinfusion: 7,
      agitation: 18,
      filterType: "paper",
      bedUniformity: 72,
      channelingRisk: 28,
      extractionEfficiency: 80,
      mineralStrength: 58,
      acidityBuffering: 38,
      bodyEmphasis: 70,
      clarityEmphasis: 45
    ...
    ranges: buildMethodRanges({
      dose: { min: 15, max: 22, step: 0.5 },
      brewRatio: { min: 1.6, max: 3.0, step: 0.1 },
      grindSize: { min: 8, max: 35, step: 1 },
      fines: { min: 30, max: 70, step: 1 },
      contactTime: { min: 20, max: 45, step: 1 },
      pressure: { min: 6.5, max: 10, step: 0.1 },
      pressureAggressiveness: { min: 10, max: 80, step: 1 },
      preinfusion: { min: 0, max: 14, step: 1 },
      agitation: { min: 0, max: 35, step: 1 },
      filterType: { options: ["paper", "metal"] },
      temperature: { min: 89, max: 96, step: 1 }
    }),
    coeff: { speed: 1.08, clarity: 0.54, body: 1.2, bitterness: 1.12, aroma: 1.0, immersion: 0.08, windowWidth: 0.32 }
  },
  pourOver: {
    label: "Pour Over",
    ...
    ranges: buildMethodRanges({
      ...
      grindSize: { min: 48, max: 85, step: 1 },
      fines: { min: 12, max: 45, step: 1 },
      contactTime: { min: 120, max: 420, step: 5 },
      pressure: { min: 1, max: 1.8, step: 0.1 },
  ...
  frenchPress: {
    ...
    ranges: buildMethodRanges({
      ...
      grindSize: { min: 68, max: 95, step: 1 },
      fines: { min: 15, max: 55, step: 1 },
      contactTime: { min: 180, max: 720, step: 5 },
  ...
  siphon: {
    ...
    ranges: buildMethodRanges({
      ...
      grindSize: { min: 45, max: 72, step: 1 },
      fines: { min: 14, max: 48, step: 1 },
      contactTime: { min: 70, max: 210, step: 5 },
      pressure: { min: 1, max: 2.0, step: 0.1 },
  ...
  aeroPress: {
    ...
    ranges: buildMethodRanges({
      ...
      grindSize: { min: 35, max: 75, step: 1 },
      fines: { min: 12, max: 55, step: 1 },
      contactTime: { min: 45, max: 210, step: 5 },
      pressure: { min: 1, max: 2.8, step: 0.1 },
      pressureAggressiveness: { min: 5, max: 65, step: 1 },
  ...
  coldBrew: {
    ...
    ranges: buildMethodRanges({
      ...
      grindSize: { min: 70, max: 95, step: 1 },
      fines: { min: 5, max: 35, step: 1 },
      contactTime: { min: 28800, max: 86400, step: 1800 },
